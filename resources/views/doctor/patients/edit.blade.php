@extends('doctor.layouts.app', ['page' => 'patient'])
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            ...
            <form action="{{ route('doctor.patients.update', $Patient->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box ">
                            ...
                            <div class="form-group row">
                                <label for="diabetes_type" class="col-md-3 col-form-label text-md-right">نوع السكري</label>
                                <div class="col-md-6">
                ...
                <a href="{{ route('doctor.patients.index') }}" class="btn btn-default">
                    إلغاء
                </a>
            </form>
        </div>

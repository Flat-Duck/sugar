...
@section('content')
    ...
    <div class="box box-primary direct-chat direct-chat-primary">
            ...
            <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg {{ $chat->ismine?'right':'' }}">
                    <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name {{ $chat->ismine?'':'pull-left' }} "> {{ $chat->ismine? $chat->doctor->name : $chat->patient->name }} </span>
        ...
        <div class="box-footer">
            <form action="{{ route('doctor.chats',['patient'=>$chat->patient->id]) }}" method="post">
                @csrf
